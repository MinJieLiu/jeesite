...
function tableSort(configuration) {
    ...
    var $orderBy = $(config.orderBy), $sortCol = $(config.contentTable + " th." + config.sortClass), orderBy = $orderBy
            .val().split(" ");
    ...
    $sortCol.click(function() {
        var order = $(this).attr("class").split(" "), sort = $orderBy.val().split(" ");
